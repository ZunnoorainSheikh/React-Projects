    ...
    <>
      <div className="container my-4">
        <div className="form-group">
          <label htmlFor="exampleFormControlTextarea1"style={
              {
          ...
          <textarea
            ...
            style={
              {
                backgroundColor:props.mode==='light'?'white':'rgba(33,37,41,255)                ',
                color:props.mode==='light'?'black':'white'
              }
            }
          />
        ...
        <hr style={
              {
                backgroundColor:props.mode==='light'?'rgba(33,37,41,255)':'white'
              }
            }/>
      </div>
